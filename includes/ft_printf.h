...
int						ft_print_d_u_x_add_on(long nbr, int count_digit,
							t_flag *flag);
...
void					ft_putnbr_printf(long nbr, int i_max,
							t_flag *flag, char *base);
void					ft_putnbr_p_printf(long long int nbr, int i_max,
							t_flag *flag, char *base);
int						ft_count_digit_p(unsigned long long int nbr,
							t_flag *flag);
